...
export class PaisComponent {
  ...
  paises: any = {
    peru: {
      ...
      img: 'https://www.sitographics.com/enciclog/banderas/america/image_2012/Peru.gif',
    },
    chile: {
      nombre: 'Chile',
      texto:
      ...
      img: 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/78/Flag_of_Chile.svg/2560px-Flag_of_Chile.svg.png',
    },
    uruguay: {
      nombre: 'Uruguay',
      texto:
